                ...
                <div className="ml-2">
                    ...
                    <span className="flex-auto w-10">
                        ...
                        {!currentUser ? <Link to="/login"><TopRightButton>Log-In</TopRightButton></Link>
                            : <button onClick={() => {dispatch(logoutThunk()); navigate("/")}} className="bg-red-700 hover:bg-blue-700 text-white text-[8px] sm:text-md md:text-lg font-bold mx-1 py-2 px-1 sm:mx-3 sm:py-2 sm:px-4 rounded focus:outline-none focus:shadow-outline">Log-Out</button>}
                    </span>
