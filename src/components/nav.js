...
function Nav() {
    ...
    function TopRightButton({ children }) {
        return <button className="bg-blue-500 hover:bg-blue-700 text-white text-[8px] font-bold mx-1 py-2 px-1 sm:text-md md:text-lg sm:mx-3 sm:py-2 sm:px-4 rounded focus:outline-none focus:shadow-outline">{children}</button>
    }
